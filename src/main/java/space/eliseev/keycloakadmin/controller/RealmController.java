...
public class RealmController {
    ...
    @Operation(summary = "Get all realms", description = "It can be used to get list of all realms in all realms",
            tags = {"realm"})
    @ApiResponses(value = {
    ...
    @Operation(summary = "Get realm by name", description = "It returns list of realms with specified name in all realms",
            tags = {"realm"})
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", content = @Content(mediaType = "application/json",
                    array = @ArraySchema(schema = @Schema(implementation = Realm.class))),
